                ...
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="blog-list">
                        ...
                        <div class="each-blog-standared">
                            <h2 class="f-700 mb-20 lh-12">{{$category->title}}</h2>
                            <div class="blog-img-detail mb-25">
                                <img src="{{$category->image}}" alt="">
                                <div class="blog-date text-center">
                                    <h2 class="day green mb-10 f-700">{{substr($category->created, 8, 10)}}</h2>
                                ...
                                <div class="blog-by-info mb-10">
                                    <ul class="list-inline fs-12">
                                        <li class="list-inline-item pr-15">
                                            <i class="far fa-calendar mr-10 fs-14 green"></i> {{$category->created}}</li>
                                        <li class="list-inline-item pr-15">
                                            <i class="far fa-user mr-10 fs-14 green"></i> {{$category->author}}</li>
                                        <li class="list-inline-item pr-15">
                                            <i class="far fa-comments mr-10 fs-14 green"></i> {{$category->comment == '' ? '0' : $post->comment}} Comments</li>
                                    </ul>
                                </div>
                                <p class="mb-20">{{substr($category->post, 0, 150)}}...</p>
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                    <a href="{{route('detail.get', ['id'=> $category->post_id])}}" class="btn btn-square">LEARN MORE<i class="fas fa-long-arrow-alt-right ml-20"></i></a>
                                    </div>
